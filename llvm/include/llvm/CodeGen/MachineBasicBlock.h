...
public:
  ...
  /// The first instruction which is not debug, CFI instruction, etc.
  iterator getFirstActualInstr();
  const_iterator getFirstActualInstr() const {
    return const_cast<MachineBasicBlock *>(this)->getFirstActualInstr();
  }

  /// The last instruction which is not debug, CFI instruction, etc.
  iterator getLastActualInstr();
  const_iterator getLastActualInstr() const {
    return const_cast<MachineBasicBlock *>(this)->getLastActualInstr();
  }
