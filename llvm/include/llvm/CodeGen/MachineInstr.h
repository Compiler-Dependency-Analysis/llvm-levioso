...
public:
  ...
  MachineFunction *getMF() {
    ...
    /// Ali : a set of data dependent, control depedendet for each machine instructions
  std::set<MachineInstr*> data_dependent;
  std::set<MachineInstr*> control_dependent;
  std::set<MachineInstr*> dependent_insts;

  int line;
  MachineBasicBlock* reconvergence_point;
  //a unique number for the instruction within the function
