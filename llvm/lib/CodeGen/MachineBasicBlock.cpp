...
MachineBasicBlock::iterator MachineBasicBlock::getFirstActualInstr() {
  iterator B = begin(), E = end(), I = B;

  while (I != E){
    if (I->isDebugInstr() || I->isCFIInstruction() || I->isEHLabel() || I->isKill() || I->isImplicitDef())
      I++;
    else
      break;
  }
...
MachineBasicBlock::iterator MachineBasicBlock::getLastActualInstr() {
  // Skip over end-of-block dbg_value instructions.
  iterator B = begin(), I = end();
  while (I != B) {
    --I;
    if (I->isDebugInstr() || I->isInsideBundle() || I->isCFIInstruction() || I->isEHLabel() || I->isKill() || I->isImplicitDef())
      continue;
    return I;
  }
