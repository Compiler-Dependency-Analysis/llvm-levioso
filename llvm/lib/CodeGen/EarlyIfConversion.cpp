...
//Disables performing this pass
static cl::opt<bool> Disable("no-early-ifcvt", cl::init(false), cl::Hidden,
  cl::desc("Enable Early If Convesrion"));
...
bool EarlyIfConverter::runOnMachineFunction(MachineFunction &MF) {
  ...
  //run this pass only if it's enabled
  if (Disable)
    return false;
